    ...
    <div className="min-h-screen bg-gray-50 py-4 px-4 sm:py-8 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Complete Your Therapist Profile</h1>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <CardContent className="space-y-6 px-4 sm:px-6">
                          ...
                          <div className="flex items-start space-x-3 border rounded-lg p-4 hover:bg-muted/50">
                            ...
                            <div className="flex-1">
                              <label htmlFor="community" className="flex items-start cursor-pointer">
                                <Heart className="h-5 w-5 mr-2 mt-0.5 text-red-500 flex-shrink-0" />
                                <div>
                ...
                <FormField
                  ...
                  name="has_insurance"
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start justify-between rounded-md border p-4 space-y-0">
